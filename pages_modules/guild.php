<?php
$sql=mysql_query("SELECT * FROM clan WHERE ClanId=".$_GET['id']."");
        $i = 0;
...
if($allioriginbadge == 32000006){ $allioriginbadge ='<img src="https://clashofclans.com/img/flags/International.png" alt="10" width="22" height="22">';}/////////CREAR IMAGEN INTERNACIONAL
