<?php
//$sql=mysql_query("select * from player where MD5(concat('".$key."',".$row['PlayerId']."))=".$_GET['id']."") or die ('Database name is not available!');
...
<table class="themain" align="center" cellpadding="2" cellspacing="0" width="10%"><tbody><tr>
  ...
  <tr class="trhover">
    <td height="124" colspan="5" align="center"><div class="separator"></div>'.$th.'<div class="headernameprofile"></br>'.$playername.' '.$sx.'</div></br><div class="headernameclanprofile">'.$alliance_id.'</div></br></td>
  </tr>
  <tr class="trhover">
