...
$sql=mysql_query("SELECT * FROM player WHERE PlayerID='".$playername."' LIKE '%".$_GET['Search']."%'") or die ('Database name is not available!');//cambiar nombre de la tabla de busqueda
